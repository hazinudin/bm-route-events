...
class RouteFWDRepo(object):
    ...
    def put(self, events: RouteFWD, year: int):
        """
    ...
    def _delete(self, events: RouteFWD, year: int, conn, commit: bool = True):
        """
    ...
    def _insert(self, events: RouteFWD, year: int, conn, commit: bool = True):
        """
